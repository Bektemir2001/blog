                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="<?php echo e(route('posts.index')); ?>" id="blogDropdown">Blog</a>
                        </li>
                        <?php if(auth()->user()): ?>
                            <form class="col-6" action="<?php echo e(route('logout')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <button class="btn btn-block btn-primary btn-sm" type="submit">Logout</button>
                            </form>

                            <a class="col-6" href="<?php echo e(route('user.main.index')); ?>">
                                <button class="btn btn-block btn-primary btn-sm" type="submit">Profil</button>
                            </a>
                            <?php if(auth()->user()->role == 1): ?>
                                <a class="col-6" href="<?php echo e(route('admin.index')); ?>">
                                    <button class="btn btn-block btn-primary btn-sm" type="submit">Admin Ponel</button>
                                </a>
                            <?php endif; ?>
                        <?php else: ?>
                                <a class="col-12" href="/login">
                                    <button class="btn btn-block btn-primary btn-sm" type="submit">Login</button>
                                </a>


                                <a class="col-12" href="/register">
                                    <button class="btn btn-block btn-primary btn-sm" type="submit">Register</button>
                                </a>
...
<?php /**PATH /home/bektemir/Desktop/Laravel_pro/blog/resources/views/layouts/main.blade.php ENDPATH**/ ?>